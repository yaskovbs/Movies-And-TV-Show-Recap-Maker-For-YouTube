...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: "עדכנו את המגבלה לגודל של עד 3GB. עם זאת, חשוב לזכור שעיבוד הווידאו מתבצע ישירות בדפדפן שלכם. קבצים גדולים (במיוחד מעל 2GB) עלולים לצרוך כמות גדולה של זיכרון ולגרום לשגיאות או לקריסה של הדפדפן, תלוי במחשב שלכם. לחוויה יציבה, אנו עדיין ממליצים להשתמש בקבצים קטנים יותר במידת האפשר."
  },
  {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                <button
                  className="w-full px-6 py-4 text-right flex items-center justify-between hover:bg-gray-700/50 transition-colors"
