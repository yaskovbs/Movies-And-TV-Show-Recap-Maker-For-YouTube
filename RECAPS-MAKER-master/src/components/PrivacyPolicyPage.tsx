    ...
    <div className="min-h-screen bg-gray-900 text-white py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2>1. מבוא</h2>
          <p>
            אנו ב-Movies And TV Shows Recaps Maker For My Social Networks ("השירות") מחויבים להגן על פרטיותכם. מדיניות זו מסבירה איזה מידע אנו אוספים וכיצד אנו משתמשים בו.
          </p>
