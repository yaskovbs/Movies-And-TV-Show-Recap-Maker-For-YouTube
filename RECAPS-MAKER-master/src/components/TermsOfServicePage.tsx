    ...
    <div className="min-h-screen bg-gray-900 text-white py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p>
            ברוכים הבאים ל-Movies And TV Shows Recaps Maker For My Social Networks ("השירות"). על ידי שימוש בשירות, אתם מסכימים לתנאי שימוש אלה במלואם. אם אינכם מסכימים לתנאים, אנא אל תשתמשו בשירות.
          </p>
          ...
          <h2>4. קניין רוחני</h2>
          <p>
            כל הקוד, העיצוב והטקסטים באתר הם קניינו הבלעדי של Movies And TV Shows Recaps Maker For My Social Networks. התוכן שאתם יוצרים באמצעות השירות שייך לכם, בכפוף לזכויות היוצרים המקוריות של הווידאו.
          </p>
